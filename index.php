...
<div id="main-wrapper">
  <div class="sub-wrapper">
    <div id="mian-header">
	 ...
	 <div id="main-menu">
	 <ul id="main_menu">
	  <li class="main_menu_li"><a class="main_menu_li_a" href="index.php"><strong>Home</strong></a>
	 ...
	 <li class="sub_li"><a class="main_menu_li_a" href="frontend/pacondidates.php"><strong>PK Condidates</strong></a></li>	 
	 </ul>
	 </li>
	 <li class="main_menu_li"><a class="main_menu_li_a" href="frontend/searchvoter.php"><strong>Search</strong></a></li>
	 <li class="main_menu_li"><a class="main_menu_li_a" href="frontend/countvotes.php"><strong>Votes</strong></a></li>
	 <li class="main_menu_li"><a class="main_menu_li_a" href="backend/login.php"><strong>Login</strong></a></li>
	 </ul>
	 </div>
	</div>
	...
	<div id="main-content">
	 ...
	 <div id="footer">
	<span class="footer"><h3>Design & Developed By Ahmad Ullah & Bilal Shahzad</h3></span>
	</div>
